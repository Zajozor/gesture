...
class Canvas(scene.SceneCanvas):
    ...
    def __init__(self):
        ...
        self.line2 = EditLineVisual(pos=self.pos+10, color='r', width=2, antialias=True, method='gl')
    ...
    def on_mouse_press(self, event):
        ...
        tr2 = self.scene.node_transform(self.line2)
        pos = tr.map(event.pos)
        pos2 = tr2.map(event.pos)
        self.line.on_mouse_press(pos)
        self.line2.on_mouse_press(pos2)
    ...
    def on_mouse_move(self, event):
        ...
        pos2 = tr2.map(event.pos)
        if event.button == 1:
            self.line2.on_mouse_move(pos2)
            self.line.on_mouse_move(pos)
        else:
            self.line.highlight_markers(pos)
            self.line2.highlight_markers(pos2)
