...
void loop() {
  ...
  delay(20);  // Wait 5 seconds and scan again
}
...
Serial.print("aworld\t");
  ...
  Serial.print(values.AcZ);Serial.print("\t");
   Serial.print(values.GyX); Serial.print("\t");
   Serial.print(values.GyY);Serial.print("\t");
 Serial.print(values.GyZ);Serial.print("\t");
 Serial.println(values.Tmp); 
